 ...
 */
final class Version20260210171656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD google_id VARCHAR(100) DEFAULT NULL, CHANGE password password VARCHAR(255) DEFAULT NULL');
