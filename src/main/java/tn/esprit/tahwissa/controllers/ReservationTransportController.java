...
import tn.esprit.tahwissa.models.Reservation_transport;
import tn.esprit.tahwissa.models.Transport;
import tn.esprit.tahwissa.models.Utilisateur;
...
import tn.esprit.tahwissa.services.Reservation_transportService;
import tn.esprit.tahwissa.services.TransportService;
import tn.esprit.tahwissa.services.UtilisateurService;
...
public class ReservationTransportController {
    ...
    private void viewReservation(Reservation_transport reservation) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/transport/reservation_transport_view.fxml"));
    ...
    private void openReservationForm(Reservation_transport reservation) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/transport/reservation_transport_form.fxml"));
            Parent root = loader.load();
    ...
    private void handleSaveForm() {
        ...
        try {
            ...
            // Set user ID from session (logged-in user)
            tn.esprit.tahwissa.models.User currentUser = tn.esprit.tahwissa.utils.SessionManager.getInstance().getCurrentUser();
            if (currentUser == null) {
    ...
    private void handleBackToTransports() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/transport/transport_list.fxml"));
            Parent root = loader.load();
    ...
    private void loadReservationList() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/transport/reservation_transport_list.fxml"));
            Parent root = loader.load();
            ReservationTransportController controller = loader.getController();
            controller.setContentArea(contentArea);
            if (filterByTransportId != null) {
