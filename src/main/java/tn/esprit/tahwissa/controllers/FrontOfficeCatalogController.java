...
import tn.esprit.tahwissa.utils.ImageService;
import tn.esprit.tahwissa.utils.CurrencyService;
import tn.esprit.tahwissa.utils.WeatherService;
...
public class FrontOfficeCatalogController {
    ...
    private void openReservationForm(Transport transport) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/transport/frontoffice_reservation_form.fxml"));
    ...
    private void handleBackToCatalog() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/transport/frontoffice_catalog.fxml"));
            Parent root = loader.load();
