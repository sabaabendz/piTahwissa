...
public class TransportController {
    ...
    private void viewTransport(Transport transport) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/transport/transport_view.fxml"));
    ...
    private void openTransportForm(Transport transport) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/transport/transport_form.fxml"));
            Parent root = loader.load();
