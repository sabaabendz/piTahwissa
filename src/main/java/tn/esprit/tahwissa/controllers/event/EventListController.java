...
import tn.esprit.tahwissa.controllers.MainLayoutController;
import tn.esprit.tahwissa.models.Evenement;
import tn.esprit.tahwissa.services.EvenementService;
import tn.esprit.tahwissa.services.EventReactionService;
import tn.esprit.tahwissa.utils.EventImageUtils;
    ...
    private void loadForm(Evenement evenement) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/fxml/event/EventForm.fxml")
            );
            ...
            // Recharge la liste après fermeture
            refreshEventCards();
