...
public class UserService implements IService<User> {
    ...
    public UserService() {
        try {
            ...
            System.err.println("❌ Failed to initialize UserService database connection: " + e.getMessage());
        }
    }

    @Override
    public void ajouter(User user) throws SQLException {
        System.out.println("ðŸ“ UserService.ajouter() - DÃ©but");
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            System.out.println("âœ… Utilisateur ajoutÃ© avec succÃ¨s! Lignes affectÃ©es: " + rowsAffected);
        } catch (SQLException e) {
            System.err.println("âŒ Erreur SQL lors de l'ajout:");
    ...
    public void supprimer(int id) throws SQLException {
        ...
        System.out.println("ðŸ—‘ï¸  Utilisateur supprimÃ©.");
    }
    ...
    public List<User> read() throws SQLException {
        ...
        System.out.println("ðŸ“– " + users.size() + " utilisateur(s) trouvÃ©(s).");
        return users;
    }
    ...
    public User findByEmail(String email) throws SQLException {
        System.out.println("ðŸ” Recherche de l'utilisateur par email: " + email);
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    System.out.println("âŒ Aucun utilisateur trouvÃ© avec l'email: " + email);
                }
            }
        } catch (SQLException e) {
            System.err.println("âŒ Erreur SQL lors de la recherche:");
            System.err.println("   Message: " + e.getMessage());
            throw e;
        }
        return null;
