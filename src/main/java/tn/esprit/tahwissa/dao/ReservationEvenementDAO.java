...
public class ReservationEvenementDAO {
    ...
    public boolean create(ReservationEvenement reservation) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            stmt.setDate(1, Date.valueOf(reservation.getDateReservation().toLocalDate()));
    ...
    public List<ReservationEvenement> findAll() {
        ...
        String query = "SELECT r.*, e.titre as titre_evenement, CONCAT(COALESCE(u.first_name, ''), ' ', COALESCE(u.last_name, '')) as nom_user " +
    ...
    private ReservationEvenement extractReservationFromResultSet(ResultSet rs) throws SQLException {
        ...
        if (dateReservation != null) {
            reservation.setDateReservation(dateReservation.toLocalDate().atStartOfDay());
        }
