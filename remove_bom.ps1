$directory = "c:\Users\sabso\IdeaProjects\pidevproject\testunitaire\AdminandAgentdashboard\GestionReservation\src\main\java"

$count = 0
Get-ChildItem -Path $directory -Recurse -Filter *.java | ForEach-Object {
